        ...
        <div onClick={() => setDisplayOptions(!displayOptions)} className='cursor-pointer relative'>
                ...
                {displayOptions && (
                    <div className='absolute top-10 right-0 border border-1 border-zinc-800 bg-darkBlue rounded-md p-4 min-w-[180px] z-10'>
                        ...
                        <button className='text-center text-sm w-full bg-violet text-darkBlue py-1.5 rounded-md mt-5 hover:opacity-80 smoothTransition' onClick={handleLogout}>
                            <span className=''>Log out</span>
                        </button>
                        <button className='text-center text-sm w-full bg-violet text-darkBlue py-1.5 rounded-md mt-5 hover:opacity-80 smoothTransition' onClick={deleteAccount}>
